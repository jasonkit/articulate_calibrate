function ejp = simulation(noise_lv, verbose)
    ...
    R_mirror2_z = estimate_z_axis(measurements_fix_theta);
    R_mirror2_z = ejp.R_door * ejp.R_theta' * ejp.R_door' * R_mirror2_z;
...
function a = estimate_z_axis(measurements)
